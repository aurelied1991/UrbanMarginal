 ...
 * Si le son ne sera plus utilisé, il faut le d�truire par la méthode fermer, <br>
 * afin de lib�rer la mémoire et le flux où se trouve le son. <br>
    ...
    implements Serializable, Runnable
{
  ...
  /**
   * Nombre de boucles restantes à effectuer
   */
  private int tour;
  /**
   ...
   * @throws SonException Sonexception
   */
      ...
      throws SonException
  {
    try
    {
      ...
      //On créeune information avec le format du flux et en caculant la logueneur totale du son
      DataLine.Info info = new DataLine.Info(
          Clip.class,
          this.lecteurAudio.getFormat(),
          ((int)this.lecteurAudio.getFrameLength() *
   ...
   * @param fermer <b>true</b> pour indiquer que l'on d�sire que le son soit détruit après la dernière fois qu'il joue
   */
   ...
   * @return <b>true</b> si le son est entrain d'être jou�
   */
  ...
  /**
   * Indique à tous les écouteurs d'événements son, que le son est terminé
   */
  ...
  /**
   * Indique à tous les écouteurs d'événements son, que le son a avancé
   */
